...
(function ($) {
  ...
  document.getElementById("execMember").innerHTML += addExecMember("Sonam Sangpo, President", "taktukgg@gmail.com", "92939923932", "https://www.facebook.com/taktuk2s/");
  ...
  document.getElementById("execMember").innerHTML += addExecMember("Tenzin Thupten, Co-treasury", "", "", ""); // Adding Board Members
  ...
  document.getElementById("boardMember").innerHTML += addExecMember("Jamyang Choesang", "", "", "", ""); //Adding New Members
  ...
  document.getElementById("newMember").innerHTML += addExecMember("Karma Dhundup", "", "", ""); // Scroll to top button appear
