...
// For newbie testing purposes
// var btn = document.getElementById("fire");
// btn.addEventListener("click",function(){
// console.log(donationAmt);
// });
// i got the donation amount. now what
// Create a Stripe client.
var stripe = Stripe('pk_test_51H4eyVBq0r2kQNINF2la8aTYQHxI8JlmEOzoZfIiFspwinqAwW6yzt5rENS4af2s1KTA3mxzxPi8rUkQ8osXwlLN00AXf08zlI'); // Create an instance of Elements.
...
function stripeTokenHandler(token) {
  ...
  form.submit();
} // lets accept a card payment now.